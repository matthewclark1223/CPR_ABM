...
```{r abm2, out.width = "75%",echo=FALSE, fig.cap="Average harvest values for all agents in the final time step (30) for many combinationa of maximum harvest values and conservation area sizes. Model starting conditions include 100 individuals harvesting from a landscape of 10000 resources. The regeneration factor at each time step is 1.20.", fig.align='center', dpi=72, fig.pos= "H"}
