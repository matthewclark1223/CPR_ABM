...
plot(Pem2018LC)
raster::writeRaster(Pem2018LC,"~/Pemba_Project/HCRI_Grant/ProjectFiles/LandCoverLayers/Rd/pemmyLC2018rd.tif",overwrite=T)

Pem2018LC<-raster::raster("~/Pemba_Project/HCRI_Grant/ProjectFiles/LandCoverLayers/Rd/pemmyLC2018rd.tif")
#Plot it
